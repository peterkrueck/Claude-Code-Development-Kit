...
- **patch** (e.g., 2.2.0 → 2.2.1): bug fixes only
- **minor** (e.g., 2.2.0 → 2.3.0): new features, no breaking changes
- **major** (e.g., 2.2.0 → 3.0.0): breaking changes
